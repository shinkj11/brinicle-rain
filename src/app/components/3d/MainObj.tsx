...
const MainObj: React.FC = () => {
  ...
  return (
    <>
      <primitive name={"nullObj"} object={nullObj.scene} scale={0.1} />;
      <primitive object={sphereObj.scene} scale={0.1} />;
      <primitive name={"torus1"} object={torus1Obj.scene} scale={0.1} />;
      <primitive name={"torus2"} object={torus2Obj.scene} scale={0.1} />;
